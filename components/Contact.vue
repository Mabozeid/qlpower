<template>
	...
	<section
		class="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px] bg-[url('/public/4907157.jpg')]"
		data-aos="flip-right" id="contact" :dir="$i18n.locale === 'ar' ? 'rtl' : 'ltr'">
