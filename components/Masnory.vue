...
<section class="bg-white text-yellow-500 divide-slate-50" data-aos="fade-up" id="masnory" :dir="$i18n.locale === 'ar' ? 'rtl' : 'ltr'">
...
.capMasory {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(178deg, transparent, #78716C);
    font-weight: 500;
